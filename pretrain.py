        ...
        if rank == 0:
            ...
            if max_step_override_env is not None and "train/q_halt_accuracy" in reduced_metrics:
                try:
                    ...
                    current_halt_max = train_state.model.config.halt_max_steps
                    if (
                        ...
                        train_state.model.config.halt_max_steps = current_halt_max + 1
                        if rank == 0:
                            print(
                                f"Auto‑increased arch.halt_max_steps to {train_state.model.config.halt_max_steps}"
                            )
                except ValueError:
